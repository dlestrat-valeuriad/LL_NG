...
<head>
  ...
  <link href="<TMPL_VAR NAME="SKIN_PATH">/cnamts/images/favicon.ico" rel="icon" type="image/x-icon" />
  <link href="<TMPL_VAR NAME="SKIN_PATH">/cnamts/images/favicon.ico" rel="shortcut icon" />
  <style type="text/css">
body, a {
  background: #ddd;
  color: #fff;
